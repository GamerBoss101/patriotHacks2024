        ...
        <div className="w-full h-96">
            <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                    ...
                    <Tooltip />
                    <Legend />
                    {filters.showElectricity && <Line type="monotone" dataKey="electricity" stroke="#8884d8" name="Electricity" />}
                    {filters.showGas && <Line type="monotone" dataKey="gas" stroke="#82ca9d" name="Natural Gas" />}
                    {filters.showWaste && <Line type="monotone" dataKey="waste" stroke="#ffc658" name="Waste" />}
                </LineChart>
            </ResponsiveContainer>
        </div>
    );
